...
const tracker_routes_1 = require("../modules/tracker/tracker.routes");
...
router.use('/tracker', tracker_routes_1.TrackerRoutes);
router.use('/announcement', announcement_routes_1.AnnouncementRoutes);
